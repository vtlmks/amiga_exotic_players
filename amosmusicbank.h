...
//   void amosmusicbank_get_audio(struct amosmusicbank_state *s, float *output, int32_t frames);
...
static void amosmusicbank_get_audio(struct amosmusicbank_state *s, float *output, int32_t frames) {
	while(frames > 0) {
...
static void amosmusicbank_api_get_audio(void *state, float *output, int32_t frames) {
