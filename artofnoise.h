...
//   void artofnoise_get_audio(struct artofnoise_state *s, float *output, int32_t frames);
...
static void artofnoise_get_audio(struct artofnoise_state *s, float *output, int32_t frames) {
	while(frames > 0) {
...
static void artofnoise_api_get_audio(void *state, float *output, int32_t frames) {
