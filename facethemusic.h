...
//   void facethemusic_get_audio(struct facethemusic_state *s, float *output, int32_t frames);
...
static void facethemusic_get_audio(struct facethemusic_state *s, float *output, int32_t frames) {
	while(frames > 0) {
...
static void facethemusic_api_get_audio(void *state, float *output, int32_t frames) {
