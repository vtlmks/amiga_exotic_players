...
//   void gamemusiccreator_get_audio(struct gamemusiccreator_state *s, float *output, int32_t frames);
...
static void gamemusiccreator_get_audio(struct gamemusiccreator_state *s, float *output, int32_t frames) {
	while(frames > 0) {
...
static void gamemusiccreator_api_get_audio(void *state, float *output, int32_t frames) {
