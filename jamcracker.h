...
//   void jamcracker_get_audio(struct jamcracker_state *s, float *output, int32_t frames);
...
static void jamcracker_get_audio(struct jamcracker_state *s, float *output, int32_t frames) {
	while(frames > 0) {
...
static void jamcracker_api_get_audio(void *state, float *output, int32_t frames) {
