...
//   void med_get_audio(struct med_state *s, float *output, int32_t frames);
...
// [=]===^=[ med_get_audio ]======================================================================[=]
static void med_get_audio(struct med_state *s, float *output, int32_t frames) {
	while(frames > 0) {
...
// [=]===^=[ med_api_get_audio ]==================================================================[=]
static void med_api_get_audio(void *state, float *output, int32_t frames) {
