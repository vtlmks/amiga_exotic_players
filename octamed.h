...
//   void octamed_get_audio(struct octamed_state *s, float *output, int32_t frames);
...
// [=]===^=[ octamed_get_audio ]==================================================================[=]
static void octamed_get_audio(struct octamed_state *s, float *output, int32_t frames) {
	while(frames > 0) {
...
static void octamed_api_get_audio(void *state, float *output, int32_t frames) {
