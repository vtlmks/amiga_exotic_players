...
//   void sidmon20_get_audio(struct sidmon20_state *s, float *output, int32_t frames);
...
// [=]===^=[ sidmon20_get_audio ]=================================================================[=]
static void sidmon20_get_audio(struct sidmon20_state *s, float *output, int32_t frames) {
	while(frames > 0) {
...
static void sidmon20_api_get_audio(void *state, float *output, int32_t frames) {
