...
//   void sonicarranger_get_audio(struct sonicarranger_state *s, float *output, int32_t frames);
...
static void sonicarranger_get_audio(struct sonicarranger_state *s, float *output, int32_t frames) {
	while(frames > 0) {
...
static void sonicarranger_api_get_audio(void *state, float *output, int32_t frames) {
