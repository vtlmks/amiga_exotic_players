...
//   void synthesis_get_audio(struct synthesis_state *s, float *output, int32_t frames);
...
// [=]===^=[ synthesis_get_audio ]================================================================[=]
static void synthesis_get_audio(struct synthesis_state *s, float *output, int32_t frames) {
	while(frames > 0) {
...
static void synthesis_api_get_audio(void *state, float *output, int32_t frames) {
